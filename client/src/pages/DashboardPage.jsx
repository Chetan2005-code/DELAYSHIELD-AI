...
import { RefreshCw, Loader2, List, LayoutDashboard, History as HistoryIcon } from 'lucide-react';
...
const DashboardPage = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-slate-50">
        ...
        <div className="lg:col-span-8 flex flex-col gap-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
            ...
            <div className="md:col-span-5 flex flex-col gap-6">
              {loadingAnalysis ? (
                <div className="glass-panel p-12 flex flex-col items-center justify-center min-h-[300px]">
                  <Loader2 size={32} className="text-blue-500 animate-spin mb-4" />
                  <p className="text-blue-500 font-bold text-xs uppercase tracking-widest">Running AI Diagnostics...</p>
                </div>
              ) : (
                <>
            ...
            {/* AI Decision Panel (7/12) */}
            <div className="md:col-span-7 flex flex-col">
              <DecisionPanel insights={insights} onExecute={handleActionExecution} />
            </div>
          </div>

          {/* Deep Explanation (Full Width of Right Col) */}
          {!loadingAnalysis && insights && (
            <div className="animate-in slide-in-from-bottom-4 duration-500">
               <h2 className="text-xs font-black text-blue-900/40 uppercase tracking-widest mb-4 flex items-center gap-2">
                <HistoryIcon size={14} /> AI Contextual Reasoning
              </h2>
              <AIExplanation
      ...
      {/* ── Simulation Panel (Full Width Bottom) ── */}
      <div className="mt-8">
        <SimulationPanel />
      </div>
